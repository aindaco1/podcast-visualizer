...
The next stable release is `1.3.6`.
[Prepared release notes](docs/releases/1.3.6.md) describe its shared update and
diagnostics implementation. The current published release remains
[1.3.5](docs/releases/1.3.5.md) until release acceptance is complete.
...
The prepared [1.3.6 download](https://github.com/aindaco1/podcast-visualizer/releases/download/v1.3.6/Podcast-Visualizer-1.3.6-arm64.dmg)
will become available after publication. Until then,
[Download Podcast Visualizer 1.3.4 for Apple Silicon](https://github.com/aindaco1/podcast-visualizer/releases/download/v1.3.4/Podcast-Visualizer-1.3.4-arm64.dmg),
