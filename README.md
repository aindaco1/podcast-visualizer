...
The current stable release is `1.3.6`, with shared update and diagnostics support.
See the [release notes](docs/releases/1.3.6.md) for verification evidence.
...
[Download Podcast Visualizer 1.3.6 for Apple Silicon](https://github.com/aindaco1/podcast-visualizer/releases/download/v1.3.6/Podcast-Visualizer-1.3.6-arm64.dmg),
